...
```javascript
var sky = new ledger.sky(comm);
```

You can retrieve a public key and an address given its BIP 32 path

```javascript
sky.getWalletPublicKey_async("44'/0'/0'/0").then(
...
```javascript
var tx1 = sky.splitTransaction("");

var tx2 = sky.splitTransaction("...");
```
...
```javascript
sky.createPaymentTransactionNew_async(
   [ [tx1, 1] ],
   ["0'/0/0"],
   undefined,
...
var outputScript = sky.serializeTransactionOutputs(tx1).toString('hex');
